...
use circuits::zk_circuits::v2::fees::valid_public_protocol_fee_payment::SizedValidPublicProtocolFeePayment;
use circuits::zk_circuits::v2::fees::valid_public_protocol_fee_payment::test_helpers::create_dummy_witness_statement;
...
pub fn bench_verifier(c: &mut Criterion) {
    ...
    let (witness, statement) = create_dummy_witness_statement();
    let proof =
        singleprover_prove::<SizedValidPublicProtocolFeePayment>(witness, statement.clone())
            .unwrap();
