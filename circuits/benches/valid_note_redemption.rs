...
use circuits::zk_circuits::fees::valid_note_redemption::SizedValidNoteRedemption;
use circuits::zk_circuits::fees::valid_note_redemption::test_helpers::create_dummy_witness_statement;
