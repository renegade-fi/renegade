...
// criterion_group, criterion_main}; use num_bigint::RandBigInt;
...
//                 let price = FixedPoint::from_f64_round_down(7.5); // Between
// buy/sell worst case                 (buy_order, sell_order, buy_balance,
// sell_balance, price)             },
//             |(buy_order, sell_order, buy_balance, sell_balance, price)| {
//                 match_orders(&buy_order, &sell_order, &buy_balance,
// &sell_balance, 1, price)             },
